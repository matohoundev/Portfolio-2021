    ...
    render() {
        return (
            <div className="slideTech">
                ...
                <div className="second-slideTech" data-aos="fade-right"><p>Symfony php materialize</p></div>
                <div className="third-slideTech" data-aos="fade-left"><p><mark>React.js</mark> Google Firebase <mark>UI-design</mark></p></div>
                <div className="fourth-slideTech" data-aos="fade-right"><p>Sql Jquery <mark>Bootstrap</mark></p></div>
